...
const historyData = [
  {
    date: "05 Jun 2025",
    treatment: "Facial Glow Premium",
    doctor: "dr. Ayu Maharani, SpKK",
    duration: "75 menit",
    recommendation:
      "Lanjutkan serum Vitamin C pagi & sore. Hindari paparan matahari langsung.",
    status: "done",
  },
  {
    date: "15 Apr 2025",
    treatment: "Chemical Peeling",
    doctor: "dr. Rahma Kusuma, SpKK",
    duration: "40 menit",
    recommendation:
      "Gunakan sunscreen SPF 50+ setiap hari. Jangan exfoliasi berlebihan selama 2 minggu.",
    status: "done",
  },
  {
    date: "02 Mar 2025",
    ...
    duration: "30 menit",
    recommendation:
      "Disarankan program Chemical Peeling 3x untuk mengatasi hiperpigmentasi.",
    status: "done",
  },
];
    ...
    <div className="max-w-3xl mx-auto px-4 md:px-6 py-10">
      ...
      <div className="text-center mb-8">
        ...
        <p style={{ color: "var(--text)" }}>
          ...
          {patient ? censorName(patient.name) : "Anda"}
        </p>
      </div>
      ...
      >
        <div>
          {/* Menghitung semua total item riwayat yang ada */}
        ...
        <div>
          {/* Menghitung hanya riwayat yang statusnya 'done' (Selesai) */}
          <p
        ...
        <div>
          {/* Menghitung riwayat yang statusnya 'pending' atau belum selesai jika ada */}
          {/* Atau jika 'Total Semua' maksudnya adalah total seluruh baris data, pakai historyData.length */}
          <p
            className="text-2xl font-black"
